...
#     def __init__(self, dist_1, dist_2, dyna_factor: float):
#         self.dist_1 = dist_1
#         self.dist_2 = dist_2
...
#         return simplex(
#             self.dist_1.sample(seed=seed, sample_shape=sample_shape),
#             self.dist_2.sample(seed=seed, sample_shape=sample_shape),
#             self.dyna_factor,
#         )

#     def sample_and_log_prob(self, *, seed, sample_shape=()):
#         sample_1, log_prob1 = self.dist_1.sample_and_log_prob(
#             seed=seed, sample_shape=sample_shape
#         )
#         sample_2, log_prob2 = self.dist_2.sample_and_log_prob(
#             seed=seed, sample_shape=sample_shape
#         )
#         samples = simplex(sample_1, sample_2, self.dyna_factor)
#         log_probs = simplex(log_prob1, log_prob2, self.dyna_factor)

#         return samples, log_probs

#     def log_prob(self, value):
#         return simplex(
#             self.dist_1.log_prob(value),
#             self.dist_2.log_prob(value),
#             self.dyna_factor,
#         )
...
#         return simplex(
#             self.dist_1._sample_n(key, n),
#             self.dist_2._sample_n(key, n),
#             self.dyna_factor,
#         )
